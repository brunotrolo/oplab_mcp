...
interface ToolDef {
  tool: Tool;
  /** Build (path, queryParams) from validated args */
...
const TOOL_REGISTRY: ToolDef[] = [
  ...
  },
  {
    tool: {
      ...
      inputSchema: {
        type: "object",
        properties: {
          id: { type: "string", description: "Sigla da taxa de juros (ex: SELIC, CDI)" },
        },
        required: ["id"],
      },
    },
  ...
  },
  {
    tool: {
      ...
      inputSchema: {
        type: "object",
        properties: {
          symbol: { type: "string", description: "Código de negociação da opção (ex: PETRH245)" },
        },
        required: ["symbol"],
      },
    },
  ...
  },
  {
    tool: {
      ...
      inputSchema: {
        ...
        properties: {
          underlying: {
            type: "string",
            description: "Códigos das ações separados por vírgula para filtrar (opcional, ex: PETR4,VALE3)",
          },
        },
        required: [],
      },
    ...
    build: (a) => ({
      path: "/market/options/strategies/covered",
      params: pick(a, ["underlying"]),
    }),
  },
  {
    tool: {
    ...
    build: (a) => ({
      path: "/market/options/bs",
      params: pick(a, ["symbol", "irate", "type", "spotprice", "strike", "premium", "dtm", "vol", "duedate", "amount"]),
    }),
  },
  {
    tool: {
  ...
  // ── Quote ─────────────────────────────────────────────────────────────────
  {
    tool: {
      ...
      inputSchema: {
        type: "object",
        properties: {
          tickers: { type: "string", description: "Códigos separados por vírgula (ex: PETR4,VALE3,PETRH245)" },
        },
        required: ["tickers"],
      },
    },
  ...
  // ── Instruments ───────────────────────────────────────────────────────────
  {
    ...
    build: (a) => ({
      path: "/market/instruments/search",
      params: pick(a, ["expr", "limit", "type", "has_options", "category", "add_info"]),
    }),
  },
  {
    tool: {
    ...
    build: (a) => ({
      path: `/market/instruments/series/${String(a.symbol).toUpperCase()}`,
      params: pick(a, ["bs", "irate"]),
    }),
  },
  {
    tool: {
      ...
      inputSchema: {
        type: "object",
        properties: {
          symbol: { type: "string", description: "Código de negociação (ex: PETR4, BOVA11, IBOV)" },
        },
        required: ["symbol"],
      },
    },
  ...
  },
  {
    tool: {
      ...
      inputSchema: {
        type: "object",
        properties: {
          tickers: { type: "string", description: "Códigos separados por vírgula (ex: PETR4,VALE3,ITUB4)" },
        },
        required: ["tickers"],
      },
    },
  ...
  // ── Stocks ────────────────────────────────────────────────────────────────
  {
    ...
    build: (a) => ({
      path: "/market/stocks",
      params: pick(a, ["rank_by", "sort", "limit", "financial_volume_start"]),
    }),
  },
  {
    tool: {
    ...
    build: (a) => ({
      ...
      params: pick(a, ["page", "per", "rank_by", "sort", "financial_volume_start"]),
    }),
  },
  {
    tool: {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          with_financials: {
            type: "string",
            description: "Dados adicionais separados por vírgula: sector, name, cvmCode, currency, dre, bpp, bpa, dfc, stocks, close, dividends, fundamentals, cnpj",
          },
        },
        required: ["symbol"],
      },
    ...
    build: (a) => ({
      path: `/market/stocks/${String(a.symbol).toUpperCase()}`,
      params: pick(a, ["with_financials"]),
    }),
  },
  ...
  // ── Statistics — Realtime ──────────────────────────────────────────────────
  {
    ...
    build: (a) => ({
      path: "/market/statistics/realtime/highest_options_volume",
      params: pick(a, ["order_by", "limit"]),
    }),
  },
  {
    tool: {
    ...
    build: (a) => ({
      path: `/market/statistics/realtime/best_covered_options_rates/${a.type}`,
      params: pick(a, ["limit"]),
    }),
  },
  {
    ...
    build: (a) => ({
      path: `/market/statistics/realtime/highest_options_variation/${a.type}`,
      params: pick(a, ["limit"]),
    }),
  },
  ...
  // ── Statistics — Ranking ───────────────────────────────────────────────────
  {
    ...
    build: (a) => ({
      path: "/market/statistics/ranking/m9_m21",
      params: pick(a, ["sort", "limit", "financial_volume_start", "days"]),
    }),
  },
  {
    tool: {
    ...
    build: (a) => ({
      path: "/market/statistics/ranking/correl_ibov",
      params: pick(a, ["sort", "limit", "financial_volume_start", "days"]),
    }),
  },
  {
    ...
    build: (a) => ({
      path: `/market/statistics/ranking/${a.attribute}`,
      params: pick(a, ["group_by", "sort", "limit", "financial_volume_start"]),
    }),
  },
  {
    tool: {
    ...
    build: (a) => ({
      path: "/market/statistics/ranking/oplab_score",
      params: pick(a, ["score_start", "financial_volume_start", "group_by", "sort", "limit"]),
    }),
  },
  ...
  // ── Historical ────────────────────────────────────────────────────────────
  {
    ...
    build: (a) => ({
      path: `/market/historical/${String(a.symbol).toUpperCase()}/${a.resolution}`,
      params: pick(a, ["from", "to", "amount", "raw", "smooth", "df"]),
    }),
  },
  {
    tool: {
    ...
    build: (a) => ({
      path: `/market/historical/options/${String(a.spot).toUpperCase()}/${a.from}/${a.to}`,
      params: pick(a, ["symbol"]),
    }),
  },
  {
    tool: {
  ...
  },
  {
    tool: {
      ...
      inputSchema: {
        type: "object",
        properties: {
          uid: { type: "string", description: "UID da bolsa (ex: BVMF para a B3)" },
        },
        required: ["uid"],
      },
    },
